/* ******************************* PAGINA PORTIFOLIO - SLIDES  ****************************** */

var values = document.getElementById('hdnPortifolio').value;
//array1 = values ? values.split(","): new Array("img/VetorCleberson.jpg", "img/VetorTaty.jpg", "img/logoHTModas.jpg");
array1 = values ? values.split(",") : new Array();
function comeco() {
...
/* *******************************  PAGINA CONTATO - MOSTRAR CAMINHO DO ARQUIVO ANEXO ****************************** */
